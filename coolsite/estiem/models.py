...
class Estiem(models.Model):
    ...
    kind = models.ForeignKey('Kind', on_delete=models.PROTECT, null=True, verbose_name="Вид события")
    ...
    class Meta:
        verbose_name = 'Событие в Эстиме'
        verbose_name_plural = 'События в Эстиме'
